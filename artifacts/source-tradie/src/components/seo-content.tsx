...
export function ContentSection({
  ...
  return (
    ...
    >
      ...
      <h2
        className={`${eyebrow ? "mt-3" : ""} max-w-3xl text-3xl font-bold leading-[1.05] tracking-[-.05em] sm:text-4xl`}
      >
        {h2}
      </h2>
      <div className="mt-6 max-w-3xl space-y-4 text-base leading-7 text-[hsl(var(--muted-foreground))]">
        {children}
      </div>
    </section>
  );

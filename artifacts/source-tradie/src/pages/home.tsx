        ...
        <section className="paper-grid relative">
          <div className="content-wrap grid items-center gap-8 py-10 md:min-h-[500px] md:grid-cols-[1.1fr_.9fr] md:gap-10 md:py-6 lg:min-h-[520px] lg:py-8">
            <div className="animate-rise">
              ...
              <h1 className="max-w-3xl text-[clamp(3.5rem,9vw,7.9rem)] font-bold leading-[.87] tracking-[-.085em]">Need a tradie?<br /><span className="hero-tradie font-display font-normal italic text-[hsl(var(--secondary))]"><span className="hero-tradie-word">Tell us once.</span></span></h1>
              <p className="mt-6 max-w-xl text-lg leading-8 text-[hsl(var(--muted-foreground))] md:mt-5">Describe the job, add photos and your suburb. SourceTradie finds a suitable local tradie, coordinates the next step and lets you decide before the job moves forward.</p>

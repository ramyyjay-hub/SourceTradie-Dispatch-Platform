...
export const GetJobResponse = zod.object({
  ...
  "paidFlowState": zod.enum(['not_started', 'serviceable', 'manual_review', 'unsupported', 'checkout_started', 'payment_confirmed', 'sourcing', 'match_ready', 'approved', 'completed', 'sourcing_failed', 'refund_pending', 'refunded']),
  "paidMatch": zod.union([zod.object({
  "providerName": zod.string(),
  "providerPhone": zod.string().nullable(),
  "priceMinCents": zod.number(),
  "priceMaxCents": zod.number(),
  "eta": zod.string(),
 ...
 */
export const RunServiceabilityCheckParams = zod.object({
  "id": zod.coerce.number()
})

export const RunServiceabilityCheckResponse = zod.object({
 ...
 */
export const ListPaidJobsResponseItem = zod.object({
  "id": zod.number(),
  "reference": zod.string(),
  "description": zod.string(),
  "trade": zod.string(),
  ...
  "serviceAddressLine2": zod.string().nullish(),
  "paidFlowState": zod.enum(['not_started', 'serviceable', 'manual_review', 'unsupported', 'checkout_started', 'payment_confirmed', 'sourcing', 'match_ready', 'approved', 'completed', 'sourcing_failed', 'refund_pending', 'refunded']),
  "serviceabilityReason": zod.string().nullish(),
  "matchedProviderName": zod.string().nullish(),
  "matchedProviderPhone": zod.string().nullish(),
  "matchedProviderPriceMinCents": zod.number().nullish(),
  "matchedProviderPriceMaxCents": zod.number().nullish(),
  "matchedProviderEta": zod.string().nullish(),
  "matchedProviderNotes": zod.string().nullish(),
  "createdAt": zod.string(),
  "updatedAt": zod.string()
})
export const ListPaidJobsResponse = zod.array(ListPaidJobsResponseItem)
 ...
 */
export const RecordManualMatchParams = zod.object({
  "id": zod.coerce.number()
})

export const recordManualMatchBodyProviderNameMax = 200;

export const recordManualMatchBodyProviderPhoneMax = 40;

export const recordManualMatchBodyPriceMinCentsMin = 0;

export const recordManualMatchBodyPriceMaxCentsMin = 0;

export const recordManualMatchBodyEtaMax = 200;

export const recordManualMatchBodyNotesMax = 2000;



export const RecordManualMatchBody = zod.object({
  "providerName": zod.string().min(1).max(recordManualMatchBodyProviderNameMax),
  "providerPhone": zod.string().max(recordManualMatchBodyProviderPhoneMax).optional(),
  "priceMinCents": zod.number().min(recordManualMatchBodyPriceMinCentsMin),
  "priceMaxCents": zod.number().min(recordManualMatchBodyPriceMaxCentsMin),
  "eta": zod.string().min(1).max(recordManualMatchBodyEtaMax),
  "notes": zod.string().max(recordManualMatchBodyNotesMax).optional()
})

export const RecordManualMatchResponse = zod.object({
  "ok": zod.literal(true)
})
 ...
 */
export const MarkSourcingFailedParams = zod.object({
  "id": zod.coerce.number()
})

export const MarkSourcingFailedResponse = zod.object({
  "ok": zod.literal(true),
  "refund": zod.enum(['initiated', 'failed', 'no_payment_on_file'])
})
 ...
 */
export const MarkJobCompletedParams = zod.object({
  "id": zod.coerce.number()
})

export const MarkJobCompletedResponse = zod.object({
  "ok": zod.literal(true)
})
 ...
 */
export const createPartnerBodySubmissionIdRegExp = new RegExp('^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-5][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$');
export const createPartnerBodyFunnelSessionIdRegExp = new RegExp('^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-5][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$');
export const createPartnerBodyAttributionUtmSourceMax = 100;

export const createPartnerBodyAttributionUtmMediumMax = 100;

export const createPartnerBodyAttributionUtmCampaignMax = 100;



export const CreatePartnerBody = zod.object({
  "submissionId": zod.string().regex(createPartnerBodySubmissionIdRegExp),
  "businessName": zod.string(),
  "contactName": zod.string(),
  ...
  "services": zod.array(zod.string()).optional(),
  "emergencyJobs": zod.boolean().optional(),
  "funnelSessionId": zod.string().regex(createPartnerBodyFunnelSessionIdRegExp).optional(),
  "attribution": zod.object({
  "utmSource": zod.string().max(createPartnerBodyAttributionUtmSourceMax).optional(),
  "utmMedium": zod.string().max(createPartnerBodyAttributionUtmMediumMax).optional(),
  "utmCampaign": zod.string().max(createPartnerBodyAttributionUtmCampaignMax).optional()
}).optional()
})
 ...
 */
export const ListPendingPartnerApplicationsResponseItem = zod.object({
  "id": zod.number(),
  "businessName": zod.string(),
  "contactName": zod.string(),
  "abn": zod.string().nullish(),
  ...
  "acknowledgementStatus": zod.string(),
  "acquisitionUtmSource": zod.string().nullish(),
  "acquisitionUtmMedium": zod.string().nullish(),
  "acquisitionUtmCampaign": zod.string().nullish()
}))
export const ListPendingPartnerApplicationsResponse = zod.array(ListPendingPartnerApplicationsResponseItem)


/**
 * @summary Record a privacy-conscious partner acquisition funnel event
 */
export const recordPartnerFunnelEventBodySessionIdRegExp = new RegExp('^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-5][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$');
export const recordPartnerFunnelEventBodyAttributionUtmSourceMax = 100;

export const recordPartnerFunnelEventBodyAttributionUtmMediumMax = 100;

export const recordPartnerFunnelEventBodyAttributionUtmCampaignMax = 100;



export const RecordPartnerFunnelEventBody = zod.object({
  "sessionId": zod.string().regex(recordPartnerFunnelEventBodySessionIdRegExp),
  "eventType": zod.enum(['partner_page_viewed', 'partner_application_started']),
  "attribution": zod.object({
  "utmSource": zod.string().max(recordPartnerFunnelEventBodyAttributionUtmSourceMax).optional(),
  "utmMedium": zod.string().max(recordPartnerFunnelEventBodyAttributionUtmMediumMax).optional(),
  "utmCampaign": zod.string().max(recordPartnerFunnelEventBodyAttributionUtmCampaignMax).optional()
}).optional()
})

export const RecordPartnerFunnelEventResponse = zod.void()
 ...
 */
export const GetPartnerAcquisitionSummaryResponse = zod.object({
  "totals": zod.object({
  "views": zod.number(),
  "starts": zod.number(),
  "submits": zod.number(),
  "viewToStartRate": zod.number().nullable().describe('starts \/ views, or null when there are no views'),
  "startToSubmitRate": zod.number().nullable().describe('submits \/ starts, or null when there are no starts'),
  "viewToSubmitRate": zod.number().nullable().describe('submits \/ views, or null when there are no views')
}),
...
export const ListDispatchOffersResponseItem = zod.object({
  ...
  "emailNotificationStatus": zod.enum(['pending', 'sent', 'delivered', 'failed']).optional(),
  "smsNotificationStatus": zod.enum(['pending', 'sent', 'delivered', 'failed']).optional()
})
